...
def parse_json_stream_realtime(stream):
    """
    真正的流式解析器，实时yield每个字符
    返回 (event_type, key, value_chunk) 的生成器
        ...
        for c in chunk:  # 逐字符处理
            ...
            if escape:
                ...
                if reading_key:
                    ...
                    yield ("value_chunk", current_key, c)
                continue
